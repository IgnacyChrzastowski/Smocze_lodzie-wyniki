    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tbl-brand {
            ...
            gap: 8px;
            padding: 6px 16px;
            border-bottom: 1px solid rgba(13, 48, 112, 0.7);
        }
        .tbl-logo {
            height: 20px;
            width: auto;
        ...
        .race-header {
            ...
            letter-spacing: .1em;
            text-align: center;
            border-bottom: 2px solid rgba(13, 48, 112, 0.7);
            line-height: 1.3;
        }
        .race-header-text { }
        .race-header-opis {
        ...
        .race-row {
            display: flex;
            align-items: stretch;
            border-bottom: 1px solid rgba(13, 30, 66, 0.7);
            background: rgba(8, 15, 34, 0.78);
            min-height: 54px;
        }
        .race-row:nth-child(even) { background: rgba(10, 19, 40, 0.78); }
        ...
        .tbl-tory .col-label {
            ...
            text-transform: uppercase;
            letter-spacing: .1em;
            border-right: 1px solid rgba(13, 38, 80, 0.7);
            display: flex;
            align-items: center;
